...
export default function CardProduct({ thumb_src, thumb_alt, title, description, price, color, colors, position }: Props) {
  const classList = "card-body " + "text-" + position;

  return (
    <>
      <div className="card card-product border border-white mb-5 shadow-xs">
        <a href="/astro-ecommerce/productdetail/">
          ...
          <div className={classList}>
            ...
            {price && <p className="mb-0 text-sm text-body mt-1 mb-3">${price.toFixed(2)}</p>}
